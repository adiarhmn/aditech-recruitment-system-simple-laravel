            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative group">
                        <button class="flex items-center gap-2 text-sm text-white focus:outline-none">
                            <div
                                class="w-8 h-8 rounded-full bg-blue-700 flex items-center justify-center border border-blue-600">
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-3">
                                <div class="flex-shrink-0 w-12 text-center bg-blue-50 rounded-lg p-1">
