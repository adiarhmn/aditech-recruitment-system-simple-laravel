...
The project follows the standard Laravel directory structure with specific organization for views:
...
*   `resources/views/`: 
    *   `components`: Global and Shared like Navigation, Button, Card, Table, etc
    *   `features/[name_of_features]/components`: Components for current features
    *   `features/public`: Page for public like landing page, about etc.
    *   `features/auth/`:  Authentication features views and components (Login, Register).
